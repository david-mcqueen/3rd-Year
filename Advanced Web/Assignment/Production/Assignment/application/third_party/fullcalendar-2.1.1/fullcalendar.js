...
;;
    ...
    fcViews.FourWeek = FourWeek; // register the view

    function FourWeek(calendar) {
        BasicView.call(this, calendar); // call the super-constructor
    }

    FourWeek.prototype = createObject(BasicView.prototype); // define the super-class
    $.extend(FourWeek.prototype, {
        ...
        render: function(date) {
            ...
            this.intervalStart = date.clone().add(7, 'days').stripTime().startOf('week');
            ...
            this.title = (this.calendar.formatDate(this.intervalStart, this.opt('titleFormat')) + " - " + this.calendar.formatDate(this.intervalEnd.clone().subtract(1, 'days'), this.opt('titleFormat')));
